...
- 能接受“失败也是正常路径”的思维
- 能用 `do-catch` 处理基础错误分支
- 能给用户展示更可理解的失败提示，而不是只留空白
...
这一步会很明显地把你的页面从“只有成功路径”提升到“更接近真实产品”。

## 下一章为什么建议继续学主题系统

当功能逻辑逐渐变多后，页面的另一个常见问题就是：

- 样式和视觉规则越来越乱

所以建议接着看：

- [28 主题系统基础：让页面颜色和样式更统一](/D:/Documents/GitHub/swiftui-learnig/28-theme-system/README.md)
