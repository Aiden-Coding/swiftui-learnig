...
- 知道哪些数据适合用 `@AppStorage` 保存
- 能让一个设置项在下次打开 App 时保留下来
- 能分清“运行时状态”和“本地持久化数据”的区别
...
- [17 测试基础：先验证逻辑，再放心改代码](/D:/Documents/GitHub/swiftui-learnig/17-testing-basics/README.md)
