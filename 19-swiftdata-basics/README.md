...
- 知道什么时候该用 SwiftData，而不是只用简单本地设置
- 能看懂 `@Model`、`@Query`、`modelContext` 三者的基本分工
- 能完成一个最小的新增、展示、删除本地记录流程
...
哪怕只是一组最简单的笔记或打卡记录，这一步都会让你明显感受到项目层级的提升。
...
- [20 架构基础：分层不是为了高级，而是为了不乱](/D:/Documents/GitHub/swiftui-learnig/20-architecture-basics/README.md)
