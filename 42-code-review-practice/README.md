...
1. 在工程中创建本章练习视图：Chapter42PracticeView。
...
struct Chapter42PracticeView: View {
    @State private var counter = 0
    @State private var showDetail = false

    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("第 42 章：Code Review 实践")
                .font(.headline)

            Text("核心目标：用风险优先思路完成评审。")
...
你已经完成第 42 章的核心学习。建议花 10 分钟做一次“复述训练”：不用看文档，口头讲清本章的概念、代码结构和排错方法，这会显著提升你的掌握度。
