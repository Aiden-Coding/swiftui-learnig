...
你正在学习 模态展示：sheet、alert、confirmationDialog，目标是把这个能力直接用到真实页面里。

## 本章术语先看懂

- 关键词：状态、布局、交互、可维护性
- 一句话理解：通过本章案例掌握 模态展示：sheet、alert、confirmationDialog 的核心用法。

## 手把手步骤（每一步都有预期结果）

1. 创建并打开 Chapter10CaseView。
2. 粘贴完整示例代码并运行。
3. 操作按钮或输入框，观察状态变化。
4. 修改一处文案或样式并再次运行。
5. 完成小测和练习任务。
