...
struct Chapter10PracticeView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                Text("第 10 章：模态展示：sheet、alert、confirmationDialog")
                    .font(.headline)

                Text("核心目标：区分导航与模态展示场景。")
...
本章结束后，你应该已经能完成：按场景正确选择展示方式。。如果还不稳，先重复“手把手步骤”一次，再进入下一章。