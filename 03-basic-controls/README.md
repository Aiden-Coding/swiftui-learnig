...
会组合 Text、Image、Button 构建基础界面。

可以先记住一句话：**先跑通，再解释；先简单，再复杂**。这会让你学习 SwiftUI 的效率明显更高。

## 手把手操作步骤

1. 在工程中创建本章练习视图：Chapter03PracticeView。
...
struct Chapter03PracticeView: View {
    @State private var counter = 0
    @State private var showDetail = false

    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("第 03 章：文本、图片、按钮与基础组件")
                .font(.headline)

            Text("核心目标：会组合 Text、Image、Button 构建基础界面。")
            ...
            if showDetail {
                Text("练习提示：优先使用 SF Symbols，能减少素材准备成本。")
                    .font(.footnote)
                    .padding(10)
...
优先使用 SF Symbols，能减少素材准备成本。

## 本章小结

你已经完成第 03 章的核心学习。建议花 10 分钟做一次“复述训练”：不用看文档，口头讲清本章的概念、代码结构和排错方法，这会显著提升你的掌握度。
