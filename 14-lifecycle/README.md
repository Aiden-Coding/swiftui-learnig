...
- 能分清 `.onAppear`、`.onDisappear`、`.task` 的使用场景
- 能把“页面出现时做什么、离开时做什么”组织清楚
- 能避免定时器或异步任务在页面离开后继续乱跑
...
- 一份数据如果要被多个视图一起读和改，该怎么组织

所以建议接着看：

- [15 可观察数据流：让多个页面共享数据变化](/D:/Documents/GitHub/swiftui-learnig/15-observable-data-flow/README.md)
