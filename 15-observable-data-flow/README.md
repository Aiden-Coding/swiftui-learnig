...
- 能解释为什么某些数据不能只放在 `@State` 里
- 能分清 `@StateObject` 和 `@ObservedObject`
- 能让多个视图真正共享并同步同一份数据
...
- [16 本地持久化：让数据在下次打开时还在](/D:/Documents/GitHub/swiftui-learnig/16-persistence/README.md)
