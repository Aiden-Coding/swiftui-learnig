...
1. 在工程中创建本章练习视图：Chapter34PracticeView。
...
struct Chapter34PracticeView: View {
    @State private var counter = 0
    @State private var showDetail = false

    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            Text("第 34 章：Widget 入门")
                .font(.headline)

            Text("核心目标：输出可快速读取的摘要信息。")
            ...
            if showDetail {
                Text("练习提示：Widget 讲究一眼看懂，不讲究功能全。")
                    .font(.footnote)
                    .padding(10)
...
Widget 讲究一眼看懂，不讲究功能全。

## 本章小结

你已经完成第 34 章的核心学习。建议花 10 分钟做一次“复述训练”：不用看文档，口头讲清本章的概念、代码结构和排错方法，这会显著提升你的掌握度。
