...
这一步很适合帮你建立最初的“请求别都塞进页面里”的意识。

## 下一章为什么建议继续学错误处理

网络请求一旦开始真实起来，下一个立刻会遇到的问题就是：
...
- [27 错误处理基础：不要只处理成功结果](/D:/Documents/GitHub/swiftui-learnig/27-error-handling/README.md)
