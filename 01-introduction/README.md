...
- 关键词：声明式 UI、View、Preview
- 一句话理解：理解 SwiftUI 是声明式 UI 框架，并完成开发环境准备。

## 手把手步骤（每一步都有预期结果）

1. 创建视图 Chapter01PracticeView。  
...
本章结束后，你应该已经能完成：完成工程初始化并准备后续练习。。如果还不稳，先重复“手把手步骤”一次，再进入下一章。