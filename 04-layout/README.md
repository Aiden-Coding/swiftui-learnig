...
掌握三大布局容器与 Spacer 的作用。

可以先记住一句话：**先跑通，再解释；先简单，再复杂**。这会让你学习 SwiftUI 的效率明显更高。

## 手把手操作步骤

1. 在工程中创建本章练习视图：Chapter04PracticeView。
...
struct Chapter04PracticeView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            if showDetail {
                Text("练习提示：先定层级，再调间距，不要先乱加 padding。")
                    .font(.footnote)
                    .padding(10)
...
你已经完成第 04 章的核心学习。建议花 10 分钟做一次“复述训练”：不用看文档，口头讲清本章的概念、代码结构和排错方法，这会显著提升你的掌握度。
