...
- 看懂一个基础 SwiftUI 视图是怎样由 `Text` 和修饰符组成的
- 知道修饰符顺序会影响最终显示效果
- 能自己写一个包含标题、留白、背景和圆角的简单视图
...
只要你能自己搭出来，就说明你开始真正理解“基础视图 + 修饰符”的写法了。
...
- 一个 SwiftUI 视图怎么写
- 修饰符是怎么一层层作用在 View 上的

下一章自然就会进入：

- 除了 `Text`，常见页面里最常用的基础组件还有什么

所以建议接着看：

- [03 文本、图片、按钮与基础组件](/D:/Documents/GitHub/swiftui-learnig/03-basic-controls/README.md)
