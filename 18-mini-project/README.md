...
如果你学完这一章后，能做到下面这些事，就说明你已经不再只是“会几个单独知识点”了：

- 能解释这个页面的最小功能闭环是什么
- 能独立实现“展示任务 + 勾选完成 + 添加任务 + 显示进度”
- 能主动想到空输入、任务为空、状态反馈这些边界问题
- 能发现这个页面未来哪里适合拆组件、补持久化和继续迭代

## 这章做完后，最推荐继续怎么改

如果你想把这个小项目真正变成自己的练手作品，最推荐按这个顺序继续补：
...
## 下一章为什么建议接着学 SwiftData 和架构基础

当你把这个打卡项目跑通以后，最自然的两个下一步就是：
...
- [19 SwiftData 基础](/D:/Documents/GitHub/swiftui-learnig/19-swiftdata-basics/README.md)
- [20 架构基础](/D:/Documents/GitHub/swiftui-learnig/20-architecture-basics/README.md)
