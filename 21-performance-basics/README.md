...
- 知道性能问题最常见不是“框架太慢”，而是结构不合理
- 能判断长列表什么时候该考虑 `LazyVStack` 或 `List`
- 能理解“减少不必要计算和渲染”才是性能优化的第一步
...
- [22 无障碍基础：让更多人能用你的 App](/D:/Documents/GitHub/swiftui-learnig/22-accessibility/README.md)
